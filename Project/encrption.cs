...
namespace IDEA
{
    ...
    class encrption 
    {
        ...
        public static string  function (string txt , string key )
        {

            string Key = key;
            string TextPlain = readfile(txt); 
            ...
            foreach (var text in SpiltText)
            {
                ...
                string CompleteBinaryPartitionText = text;
            ...
            int y = TextPlain.Length % 16;
            int x = (TextPlain.Length / 16);
            if (y != 0)
                x++;
            ...
            foreach (var item in Encriptionlist)
            {
                ...
                {
                    final = string.Concat(final,t);
                }

            }
              File.WriteAllText(@"D:\output.txt", final);
            return final;
